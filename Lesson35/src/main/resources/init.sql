...
INSERT INTO eshop_db.categories (id, name, rating)
...
--------------------------------------------------------
INSERT INTO eshop_db.products (id, category_id, name, description, price)
...
--------------------------------------------------------
INSERT INTO eshop_db.images(category_id, product_id, image_path)
