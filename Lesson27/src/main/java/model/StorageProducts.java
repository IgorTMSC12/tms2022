...
public class StorageProducts {
    ...
    private static List<Product> creatProducts() {
        Product mobil1 = new Product(1, "Huawei_nova9_SE.png", "Huawei nova 9 SE",
        ...
        Product mobil2 = new Product(1, "Apple_iPhone13.png", "Apple iPhone 13",
        ...
        Product mobil3 = new Product(1, "Samsung_GalaxyA52.png", "Samsung Galaxy A52",
        ...
        Product laptop1 = new Product(2, "HP_255_G8.png", "HP 255 G8",
        ...
        Product laptop2 = new Product(2, "Lenovo_IdeaPad3.png", "Lenovo IdeaPad 3",
        ...
        Product laptop3 = new Product(2, "HP_Pavilion15.png", "HP Pavilion 15",
        ...
        Product gps_navigator1 = new Product(3, "Roadmax_Uno.png", "Roadmax Uno",
                "экран 7, TFT (800 x 480), ОЗУ 256 Мб, флэш-память 8 Гб, Windows CE 6.0", 199);
        Product gps_navigator2 = new Product(3, "NAVITEL_E707.png", "NAVITEL E707",
                "экран 7, TFT (800 x 480), процессор MStar MSB2531 800 МГц, флэш-память 8 Гб, Linux", 349);
        Product gps_navigator3 = new Product(3, "GEOFOX_MID743GPS.png", "GEOFOX MID743GPS",
        ...
        Product fridges1 = new Product(4, "ATLANT_ХМ.png", "ATLANT ХМ",
        ...
        Product fridges2 = new Product(4, "Samsung_fridges.png", "Samsung RB33A3440WW/WT",
        ...
        Product fridges3 = new Product(4, "Bosch_Serie6.png", "Bosch Serie 6",
                "отдельностоящий, полный No Frost, электронное управление, класс A++, полезный объём:" +
        ...
        Product car1 = new Product(5, "BMW_3.png", "BMW 3 seria",
                "2.0 бензин, седан, передний привод", 60000);
        Product car2 = new Product(5, "AUDI_A6.png", "AUDI A6",
                "4.0 бензин, полный привод, 2018 год", 72000);
        Product car3 = new Product(5, "opel_insignia.png", "Opel Insignia",
                "2.2 бензин, 180 л.с, передний привод, 2014 год", 35000);

        Product camera1 = new Product(6, "Canon_EOS_R6.png", "Canon EOS R6",
        ...
        Product camera2 = new Product(6, "Sony_Alpha_a7.png", " Sony Alpha a7",
        ...
        Product camera3 = new Product(6, "Canon_EOS_6D.png", "Canon EOS 6D",
