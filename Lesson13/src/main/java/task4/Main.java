...
public class Main {
    public static void main(String[] args) {
        String text = "Есть строка в котором содержится текст, предложения разделены точками." +
                " Метод join является статическим.";
        TextFormatter textFormatter = new TextFormatter();
        textFormatter.splitSentences(text);
    }
}
...
//     * Если в предложении присутствует слово-палиндром, то не имеет значения какое количество слов в
//       предложении, оно выводится на экран.
