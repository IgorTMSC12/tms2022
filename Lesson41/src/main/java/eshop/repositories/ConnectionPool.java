...
public class ConnectionPool {
    ...
    private void openAdditionalConnection() throws Exception {
        try {
            ...
            throw new Exception("New Connection wasn't add in the connection pool", exception);
        }
    }
    ...
    public Connection getConnection() throws Exception {
        ...
        try {
            ...
            throw new Exception("Max count of connections was reached!", exception);
        }
        return connection;
    }
    ...
    public void closeConnection(Connection connection) throws Exception {
        if (connection != null) {
            ...
            try {
                ...
                Thread.currentThread().interrupt();
                throw new Exception("Connection wasn't returned into pool properly", exception);
            }
        }
    }
}